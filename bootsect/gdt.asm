...
gdt_start32:
    ...
    ; integrity check)
    gdt_null_descriptor32:
        dd 0x00000000
        dd 0x00000000

    ; This is defining the code sector for 32-bit
    gdt_code_descriptor32:
        ; Base: 0x00000
        ; Limit: 0xFFFFF
    ...
    ; This is defining the data sector for 32-bit
    gdt_data_descriptor32:
        ; Base: 0x0000
        ; Limit: 0xFFFF
        ; 1st flags: 0b1001
        ;   Present: 1
...
gdt_descriptor32:
    dw gdt_end32 - gdt_start32 - 1              ; The size of the GDT - 1
    dd gdt_start32                              ; Points to the start of the GDT   

; Finally these point to the code and data segments which 
; will help us jump to the right place later
code_segment    equ gdt_code_descriptor32 - gdt_start32
data_segment    equ gdt_data_descriptor32 - gdt_start32
